...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-03-2025 a las 05:56:05
...
INSERT INTO `categorias` (`id`, `nombre`, `descripcion`, `correo`, `tipo`, `imagen`) VALUES
(11, 'jabon corporal', 'super chimba', 'perfumes@gmail.com', 'rico', 'uploads/1742011935_R.jpg');
...
(1, 'georgina', '12312312', '2113123123213'),
(3, 'qwdwqdqwd', 'asdasdasdasd', 'asdasd');
...
ALTER TABLE `productos`
  ...
  ADD CONSTRAINT `productos_ibfk_2` FOREIGN KEY (`proveedor_id`) REFERENCES `proveedores` (`id`) ON DELETE CASCADE;
